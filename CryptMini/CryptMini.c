...
--*/
{
	...
	DbgPrint(("CryptMini!CryptMiniInstanceSetup: Entered\n"));
...
--*/
{
    ...
    PT_DBG_PRINT( PTDBG_TRACE_ROUTINES,
                  ("CryptMini!CryptMiniUnload: Entered\n") );
...
)
{
	...
	DbgPrint(("CryptMini!PreRead: Entered\n"));
...
)
{
	...
	DbgPrint(("CryptMini!PostRead: Entered\n"));
